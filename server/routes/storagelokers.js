...
router.get('/api/storageloker', function(request, response) {
...
router.post('/api/storageloker', function(request, response) {
  var datosUsuario = {
      id : null,
...
router.put('/api/storageloker', function(request, response) {
    var datosUsuario = {
      id:request.query.id,
